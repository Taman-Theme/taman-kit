...
class Progress  extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style(
			'taman-kit-progress',
			TAMAN_KIT_URL . 'public/css/widgets/progress.css',
			array(),
	...
	public function get_title() {
		return esc_html__( 'Progressbar', 'taman-kit' );
	}
	...
	protected function _register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		*/
		...
		$this->start_controls_section(
			'section_progress',
			array(
				'label' => esc_html__( 'Progress Bar', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			'progress_type',
			array(
				'label'   => esc_html__( 'Type', 'taman-kit' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'type-1',
				'options' => array(
					'type-1' => esc_html__( 'Inside the bar', 'taman-kit' ),
					'type-2' => esc_html__( 'Placed above ', 'taman-kit' ),
					'type-3' => esc_html__( 'Shown as tip', 'taman-kit' ),
					'type-4' => esc_html__( 'On the right', 'taman-kit' ),
					'type-5' => esc_html__( 'Inside the empty bar', 'taman-kit' ),
					'type-6' => esc_html__( 'Inside the bar with title', 'taman-kit' ),
					'type-7' => esc_html__( 'Inside the vertical bar', 'taman-kit' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => esc_html__( 'Enter your title', 'taman-kit' ),
				'default'     => esc_html__( 'Title', 'taman-kit' ),
				'label_block' => true,
		...
		$this->add_control(
			'percent',
			array(
				'label'   => esc_html__( 'Percentage', 'taman-kit' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Progress Height', 'taman-kit' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Progress Width', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
				),
		...
		$this->add_control(
			'status_bar_heading',
			array(
				'label'     => esc_html__( 'Status Bar', 'taman-kit' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'options'     => array(
					'flex-start' => array(
						'title' => esc_html__( 'Start', 'taman-kit' ),
					...
					'flex-end'   => array(
						'title' => esc_html__( 'End', 'taman-kit' ),
		...
		$this->add_responsive_control(
			'text_alignment',
			array(
				'label'       => esc_html__( 'Text Alignment', 'taman-kit' ),
				'type'        => Controls_Manager::CHOOSE,
				'label_block' => false,
				'default'     => '',
				'options'     => array(
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Percent', 'taman-kit' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_responsive_control(
			'percent_width',
			array(
				'label'      => esc_html__( 'Percent Width', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
				),
		...
		$this->add_responsive_control(
			'percent_alignment',
			array(
				'label'       => esc_html__( 'Percent Alignment', 'taman-kit' ),
				'type'        => Controls_Manager::CHOOSE,
				'label_block' => false,
				'default'     => '',
				'options'     => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'       => esc_html__( 'Percent Suffix Alignment', 'taman-kit' ),
				'type'        => Controls_Manager::CHOOSE,
				'label_block' => false,
				'default'     => 'center',
				'options'     => array(
