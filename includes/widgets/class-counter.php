...
class Counter extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Counter', 'taman-kit' );
	}
	...
	protected function register_controls() {
		...
		*/
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Counter', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'description' => esc_html__( 'Enter title for stats counter block', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Starting Number', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Ending Number', 'taman-kit' ),
				'type'    => Controls_Manager::NUMBER,
				'dynamic' => array( 'active' => true ),
				'default' => 500,
			)
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Thousands Separator', 'taman-kit' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'description' => esc_html__( 'Separator converts 125000 into 125,000', 'taman-kit' ),
				'default'     => ',',
			)
		);
		...
		$this->add_control(
			'tk_counter_d_after',
			array(
				'label'   => esc_html__( 'Digits After Decimal Point', 'taman-kit' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 0,
			)
		);
		...
		$this->add_control(
			'tk_counter_preffix',
			array(
				'label'       => esc_html__( 'Value Prefix', 'taman-kit' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'description' => esc_html__( 'Enter prefix for counter value', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			'tk_counter_suffix',
			array(
				'label'       => esc_html__( 'Value Suffix', 'taman-kit' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
				'description' => esc_html__( 'Enter suffix for counter value', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			'tk_counter_speed',
			array(
				'label'       => esc_html__( 'Rolling Time', 'taman-kit' ),
				'type'        => Controls_Manager::NUMBER,
				'description' => esc_html__( 'How long should it take to complete the digit?', 'taman-kit' ),
				'default'     => 3,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Display Options', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'description' => esc_html__( 'Use a font awesome icon or upload a custom image', 'taman-kit' ),
				'options'     => array(
					'icon'      => esc_html__( 'Font Awesome', 'taman-kit' ),
					'custom'    => esc_html__( 'Image', 'taman-kit' ),
					'animation' => esc_html__( 'Lottie Animation', 'taman-kit' ),
				),
				'default'     => 'icon',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'            => esc_html__( 'Select an Icon', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Upload Image', 'taman-kit' ),
		...
		$this->add_control(
			'lottie_url',
			array(
				'label'       => esc_html__( 'Animation JSON URL', 'taman-kit' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => array( 'active' => true ),
		...
		$this->add_control(
			'lottie_loop',
			array(
				'label'        => esc_html__( 'Loop', 'taman-kit' ),
		...
		$this->add_control(
			'lottie_reverse',
			array(
				'label'        => esc_html__( 'Reverse', 'taman-kit' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'true',
				'condition'    => array(
					'tk_counter_icon_image' => 'animation',
		...
		$this->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Choose a position for your icon', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Animations', 'taman-kit' ),
		...
		$this->add_responsive_control(
			'value_align',
			array(
				'label'     => esc_html__( 'Value Alignment', 'taman-kit' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => array(
					'flex-start' => array(
						'title' => esc_html__( 'Left', 'taman-kit' ),
		...
		$this->add_responsive_control(
			'title_align',
			array(
				'label'     => esc_html__( 'Title Alignment', 'taman-kit' ),
				'type'      => Controls_Manager::CHOOSE,
				'options'   => array(
					'left'   => array(
						'title' => esc_html__( 'Left', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'We are giving you three quick preset if you are in a hurry. Otherwise, create your own with various options', 'taman-kit' ),
				'options'     => array(
					'simple' => esc_html__( 'Simple', 'taman-kit' ),
					'circle' => esc_html__( 'Circle Background', 'taman-kit' ),
					'square' => esc_html__( 'Square Background', 'taman-kit' ),
					'design' => esc_html__( 'Custom', 'taman-kit' ),
				),
				'default'     => 'simple',
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Value', 'taman-kit' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Prefix & Suffix', 'taman-kit' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Prefix Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Suffix Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
