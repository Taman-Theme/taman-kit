...
class CountDown extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Countdown', 'taman-kit' );
	}
	...
	protected function _register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		*/
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Countdown', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'd-u-s' => esc_html__( 'Inline', 'taman-kit' ),
					'd-u-u' => esc_html__( 'Block', 'taman-kit' ),
				),
				'default' => 'd-u-u',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'          => esc_html__( 'Due Date', 'taman-kit' ),
				'type'           => Controls_Manager::DATE_TIME,
				'picker_options' => array(
					'format' => 'Ym/d H:m:s',
				),
				'default'        => gmdate( 'Y/m/d H:m:s', strtotime( '+ 1 Day' ) ),
				'description'    => esc_html__( 'Date format is (yyyy/mm/dd). Time format is (hh:mm:ss). Example: 2020-01-01 09:30.', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Time Zone', 'taman-kit' ),
				'type'        => Controls_Manager::SELECT,
				'options'     => array(
					'wp-time'   => esc_html__( 'WordPress Default', 'taman-kit' ),
					'user-time' => esc_html__( 'User Local Time', 'taman-kit' ),
				),
				'default'     => 'wp-time',
				'description' => esc_html__( 'This will set the current time of the option that you will choose.', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			'tk_countdown_units',
			array(
				'label'       => esc_html__( 'Time Units', 'taman-kit' ),
				'type'        => Controls_Manager::SELECT2,
				'description' => esc_html__( 'Select the time units that you want to display in countdown timer.', 'taman-kit' ),
				'options'     => array(
					'Y' => esc_html__( 'Years', 'taman-kit' ),
					'O' => esc_html__( 'Month', 'taman-kit' ),
					'W' => esc_html__( 'Week', 'taman-kit' ),
					'D' => esc_html__( 'Day', 'taman-kit' ),
					'H' => esc_html__( 'Hours', 'taman-kit' ),
					'M' => esc_html__( 'Minutes', 'taman-kit' ),
					'S' => esc_html__( 'Second', 'taman-kit' ),
				),
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Digits Separator', 'taman-kit' ),
				'description' => esc_html__( 'Enable or disable digits separator', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Separator Text', 'taman-kit' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Expire', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Expire Type', 'taman-kit' ),
				'label_block' => false,
				'type'        => Controls_Manager::SELECT,
				'description' => esc_html__( 'Choose whether if you want to set a message or a redirect link', 'taman-kit' ),
				'options'     => array(
					'text' => esc_html__( 'Message', 'taman-kit' ),
					'url'  => esc_html__( 'Redirection Link', 'taman-kit' ),
				),
				'default'     => 'text',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'On expiry Text', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Redirect To', 'taman-kit' ),
				'type'      => Controls_Manager::TEXT,
				'dynamic'   => array(
					'active'     => true,
					'categories' => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Strings Translation', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Day (Singular)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Day',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Day (Plural)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Days',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Week (Singular)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Week',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Weeks (Plural)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Weeks',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Month (Singular)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Month',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Months (Plural)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Months',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Year (Singular)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Year',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Years (Plural)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Years',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Hour (Singular)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Hour',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Hours (Plural)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Hours',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Minute (Singular)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Minute',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Minutes (Plural)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Minutes',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Second (Singular)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Second',
			)
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Seconds (Plural)', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
				'default' => 'Seconds',
			)
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Digits', 'taman-kit' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Background Size', 'taman-kit' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Units', 'taman-kit' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				'label'     => esc_html__( 'Spacing in Between', 'taman-kit' ),
				'type'      => Controls_Manager::SLIDER,
				'default'   => array(
					'size' => 40,
				),
		...
		$this->start_controls_section(
			...
			array(
				'label'     => esc_html__( 'Separator', 'taman-kit' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'tk_countdown_style'     => 'd-u-u',
					'tk_countdown_separator' => 'yes',
