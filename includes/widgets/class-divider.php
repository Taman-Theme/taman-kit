	...
	protected function _register_controls() {  // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		*/
		...
		$this->start_controls_section(
			'section_buton',
			array(
				'label' => esc_html__( 'Divider', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'options'     => array(
					'plain' => array(
						'title' => esc_html__( 'Plain', 'taman-kit' ),
		...
		$this->add_control(
			'divider_direction',
			array(
				'label'     => esc_html__( 'Direction', 'taman-kit' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'horizontal',
				'options'   => array(
					'horizontal' => esc_html__( 'Horizontal', 'taman-kit' ),
					'vertical'   => esc_html__( 'Vertical', 'taman-kit' ),
				),
				'condition' => array(
					'divider_type' => 'plain',
				),
		...
		$this->add_control(
			...
			array(
				...
				'default'   => esc_html__( 'Divider Text', 'taman-kit' ),
				'condition' => array(
					'divider_type' => 'text',
				),
			)
		...
		$this->add_control(
			'text_html_tag',
			array(
				'label'     => esc_html__( 'HTML Tag', 'taman-kit' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'span',
				'options'   => array(
					'h1'   => esc_html__( 'H1', 'taman-kit' ),
					'h2'   => esc_html__( 'H2', 'taman-kit' ),
					'h3'   => esc_html__( 'H3', 'taman-kit' ),
					'h4'   => esc_html__( 'H4', 'taman-kit' ),
					'h5'   => esc_html__( 'H5', 'taman-kit' ),
					'h6'   => esc_html__( 'H6', 'taman-kit' ),
					'div'  => esc_html__( 'div', 'taman-kit' ),
					'span' => esc_html__( 'span', 'taman-kit' ),
					'p'    => esc_html__( 'p', 'taman-kit' ),
				),
				'condition' => array(
					'divider_type' => 'text',
				),
		...
		*/
		...
		$this->add_control(
			...
			array(
				...
				'default'   => 'solid',
				'options'   => array(
					'solid'  => esc_html__( 'Solid', 'taman-kit' ),
					'dashed' => esc_html__( 'Dashed', 'taman-kit' ),
					'dotted' => esc_html__( 'Dotted', 'taman-kit' ),
					'double' => esc_html__( 'Double', 'taman-kit' ),
				),
				'selectors' => array(
		...
		$this->add_responsive_control(
			'horizontal_height',
			array(
				'label'          => esc_html__( 'Height', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Divider Color', 'taman-kit' ),
		...
		$this->start_controls_tab(
			'tab_before_style',
			array(
				'label'     => esc_html__( 'Before', 'taman-kit' ),
				'condition' => array(
					'divider_type!' => 'plain',
				),
			)
		...
		$this->start_controls_tab(
			'tab_after_style',
			array(
				'label'     => esc_html__( 'After', 'taman-kit' ),
				'condition' => array(
					'divider_type!' => 'plain',
				),
			)
		...
		$this->add_responsive_control(
			'icon_rotation',
			array(
				'label'          => esc_html__( 'Icon Rotation', 'taman-kit' ),
				'type'           => Controls_Manager::SLIDER,
				'size_units'     => array( '%', 'px' ),
				'range'          => array(
					'px' => array(
