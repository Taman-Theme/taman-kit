...
class Contactform7 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Contact Form7', 'taman-kit' );
	}
	...
	protected function _register_controls() {  // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Contact Form', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			'tk_wpcf7_form',
			array(
				'label'       => esc_html__( 'Select Your Contact Form', 'taman-kit' ),
				'label_block' => true,
		...
		$this->start_controls_section(
			'tk_wpcf7_fields',
			array(
				'label' => esc_html__( 'Fields', 'taman-kit' ),
			)
		);
		...
		$this->add_responsive_control(
			'tk_input_width',
			array(
				'label'      => esc_html__( 'Input Field', 'taman-kit' ),
		...
		$this->add_responsive_control(
			'tk_textarea_width',
			array(
				'label'      => esc_html__( 'Text Area', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', 'em', '%' ),
				'range'      => array(
					'px' => array(
		...
		$this->start_controls_section(
			'tk_wpcf7_button',
			array(
				'label' => esc_html__( 'Button', 'taman-kit' ),
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Form', 'taman-kit' ),
		...
		$this->add_control(
			'tk_input_background',
			array(
				'label'     => esc_html__( 'Input Field Background', 'taman-kit' ),
		...
		$this->add_control(
			'tk_input_focus',
			array(
				'label'     => esc_html__( 'Focus Border Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Focus Line Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'condition' => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Labels', 'taman-kit' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Default Font Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => array(
		...
		$this->add_control(
			...
			array(
				'type'      => Controls_Manager::HEADING,
				'label'     => esc_html__( 'Input Typography', 'taman-kit' ),
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Input Text Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Placeholder Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->start_controls_tab( 'normal', array( 'label' => esc_html__( 'Normal', 'taman-kit' ) ) );
