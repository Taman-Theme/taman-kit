...
class Instagram extends \Elementor\Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_script(
			'ofi',
			TAMAN_KIT_URL . 'public/js/ofi.min.js',
			array(),
		...
		wp_register_script(
			'taman-kit',
			TAMAN_KIT_URL . 'public/js/taman-kit.js',
			array(),
			\TamanKitHelpers::taman_kit_ver(),
			true
		);
	...
	public function get_title() {
		return esc_html__( 'Instagram Grid', 'taman-kit' );
	}
	...
	*/
	...
	protected function register_content_instaaccount_controls() {
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Instagram Account', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			'insta_display',
			array(
				'label'   => esc_html__( 'Display', 'taman-kit' ),
			...
			$this->add_control(
				...
				array(
					...
					'raw'             => sprintf(
						...
						esc_html__( 'The global Instagram access token is missing. You can add it %1$shere%2$s or use a custom one below.', 'taman-kit' ),
		...
		$this->add_control(
			'access_token',
			array(
				'label'       => esc_html__( 'Custom Access Token', 'taman-kit' ),
				'description' => esc_html__( 'Overrides global Instagram access token', 'taman-kit' ),
				'label_block' => true,
		...
		$this->add_control(
			'insta_hashtag',
			array(
				'label'       => esc_html__( 'Hashtag', 'taman-kit' ),
				'description' => esc_html__( 'Enter without the # symbol', 'taman-kit' ),
				'label_block' => false,
				'type'        => Controls_Manager::TEXT,
				'condition'   => array(
					'insta_display' => 'tags',
		...
		$this->add_control(
			'cache_timeout',
			array(
				'label'   => esc_html__( 'Cache Timeout', 'taman-kit' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'hour',
				'options' => array(
					'none'   => esc_html__( 'None', 'taman-kit' ),
					'minute' => esc_html__( 'Minute', 'taman-kit' ),
					'hour'   => esc_html__( 'Hour', 'taman-kit' ),
					'day'    => esc_html__( 'Day', 'taman-kit' ),
					'week'   => esc_html__( 'Week', 'taman-kit' ),
				),
			)
		);
		...
		$this->add_control(
			'images_count',
			array(
				'label'      => esc_html__( 'Images Count', 'taman-kit' ),
		...
		$this->add_control(
			'resolution',
			array(
				'label'   => esc_html__( 'Image Resolution', 'taman-kit' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'thumbnail'           => esc_html__( 'Thumbnail (150x150)', 'taman-kit' ),
					'low_resolution'      => esc_html__( 'Low Resolution (320x320)', 'taman-kit' ),
					'standard_resolution' => esc_html__( 'Standard Resolution (640x640)', 'taman-kit' ),
					'high'                => esc_html__( 'High Resolution (original)', 'taman-kit' ),
				),
	...
	protected function register_content_general_settings_controls() {
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'General Settings', 'taman-kit' ),
			)
		);
		...
		$this->add_responsive_control(
			'grid_cols',
			array(
				'label'          => esc_html__( 'Grid Columns', 'taman-kit' ),
				'type'           => Controls_Manager::SELECT,
				'label_block'    => false,
				'default'        => '4',
				'tablet_default' => '3',
				'mobile_default' => '2',
				'options'        => array(
					'2' => esc_html__( '2', 'taman-kit' ),
					'3' => esc_html__( '3', 'taman-kit' ),
					'4' => esc_html__( '4', 'taman-kit' ),
					'5' => esc_html__( '5', 'taman-kit' ),
					'6' => esc_html__( '6', 'taman-kit' ),
				),
		...
		$this->add_control(
			'insta_likes',
			array(
				'label'              => esc_html__( 'Likes', 'taman-kit' ),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => 'no',
				'label_on'           => esc_html__( 'Show', 'taman-kit' ),
				'label_off'          => esc_html__( 'Hide', 'taman-kit' ),
				'return_value'       => 'yes',
				'separator'          => 'before',
				'frontend_available' => true,
			)
		...
		$this->add_control(
			'insta_comments',
			array(
				'label'              => esc_html__( 'Comments', 'taman-kit' ),
				'type'               => Controls_Manager::SWITCHER,
				'default'            => 'no',
				'label_on'           => esc_html__( 'Show', 'taman-kit' ),
				'label_off'          => esc_html__( 'Hide', 'taman-kit' ),
		...
		$this->add_control(
			'insta_caption',
			array(
				'label'        => esc_html__( 'Caption', 'taman-kit' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => '',
				'label_on'     => esc_html__( 'Show', 'taman-kit' ),
				'label_off'    => esc_html__( 'Hide', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Caption Length', 'taman-kit' ),
		...
		$this->add_control(
			'content_visibility',
			array(
				'label'      => esc_html__( 'Content Visibility', 'taman-kit' ),
				'type'       => Controls_Manager::SELECT,
				'default'    => 'always',
				'options'    => array(
					'always' => esc_html__( 'Always', 'taman-kit' ),
					'hover'  => esc_html__( 'On Hover', 'taman-kit' ),
				),
				'conditions' => array(
					'relation' => 'or',
					'terms'    => array(
		...
		$this->add_control(
			'insta_image_popup',
			array(
				'label'        => esc_html__( 'Lightbox', 'taman-kit' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'label_on'     => esc_html__( 'Yes', 'taman-kit' ),
				'label_off'    => esc_html__( 'No', 'taman-kit' ),
				'return_value' => 'yes',
			)
		);
		...
		$this->add_control(
			'insta_image_link',
			array(
				'label'        => esc_html__( 'Image Link', 'taman-kit' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => '',
				'label_on'     => esc_html__( 'Yes', 'taman-kit' ),
				'label_off'    => esc_html__( 'No', 'taman-kit' ),
		...
		$this->add_control(
			'insta_profile_link',
			array(
				'label'        => esc_html__( 'Show Link to Instagram Profile?', 'taman-kit' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'label_on'     => esc_html__( 'Yes', 'taman-kit' ),
				'label_off'    => esc_html__( 'No', 'taman-kit' ),
		...
		$this->add_control(
			'insta_link_title',
			array(
				'label'     => esc_html__( 'Link Title', 'taman-kit' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => esc_html__( 'Follow Us @ Instagram', 'taman-kit' ),
				'condition' => array(
		...
		$this->add_control(
			'insta_profile_url',
			array(
				'label'       => esc_html__( 'Instagram Profile URL', 'taman-kit' ),
		...
		$this->add_control(
			'title_icon',
			array(
				'label'            => esc_html__( 'Title Icon', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::SELECT,
				'options'   => array(
					'before_title' => esc_html__( 'Before Title', 'taman-kit' ),
					'after_title'  => esc_html__( 'After Title', 'taman-kit' ),
				),
	...
	protected function register_content_help_docs() {
		...
		if ( ! empty( $help_docs ) ) {
			...
			$this->start_controls_section(
				'section_help_docs',
				array(
					'label' => esc_html__( 'Help Docs', 'taman-kit' ),
				)
			);
	...
	*/
	...
	protected function register_style_layout_controls() {
		$this->start_controls_section(
			...
			'columns_gap',
			array(
				'label'          => esc_html__( 'Columns Gap', 'taman-kit' ),
				'type'           => Controls_Manager::SLIDER,
				'default'        => array(
					'size' => '',
					'unit' => 'px',
		...
		$this->add_responsive_control(
			'rows_gap',
			array(
				'label'          => esc_html__( 'Rows Gap', 'taman-kit' ),
				'type'           => Controls_Manager::SLIDER,
				'default'        => array(
					'size' => '',
					'unit' => 'px',
	...
	protected function register_style_images_controls() {
		$this->start_controls_section(
			'section_image_style',
			array(
				'label' => esc_html__( 'Images', 'taman-kit' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'        => esc_html__( 'Grayscale Image', 'taman-kit' ),
				'type'         => Controls_Manager::SWITCHER,
				'default'      => 'no',
				'label_on'     => esc_html__( 'Yes', 'taman-kit' ),
				'label_off'    => esc_html__( 'No', 'taman-kit' ),
	...
	protected function register_style_content_controls() {
		...
		$this->add_control(
			...
			array(
				'label'                => esc_html__( 'Vertical Align', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				'label'                => esc_html__( 'Horizontal Align', 'taman-kit' ),
				'type'                 => Controls_Manager::CHOOSE,
				'label_block'          => false,
				'toggle'               => false,
				'default'              => 'center',
		...
		$this->add_control(
			'icons_heading',
			array(
				'label'      => esc_html__( 'Icons', 'taman-kit' ),
	...
	protected function register_style_overlay_controls() {
		...
		$this->add_control(
			'overlay_blend_mode',
			array(
				'label'     => esc_html__( 'Blend Mode', 'taman-kit' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'normal',
				'options'   => array(
					'normal'      => esc_html__( 'Normal', 'taman-kit' ),
					'multiply'    => esc_html__( 'Multiply', 'taman-kit' ),
					'screen'      => esc_html__( 'Screen', 'taman-kit' ),
					'overlay'     => esc_html__( 'Overlay', 'taman-kit' ),
					'darken'      => esc_html__( 'Darken', 'taman-kit' ),
					'lighten'     => esc_html__( 'Lighten', 'taman-kit' ),
					'color-dodge' => esc_html__( 'Color Dodge', 'taman-kit' ),
					'color'       => esc_html__( 'Color', 'taman-kit' ),
					'hue'         => esc_html__( 'Hue', 'taman-kit' ),
					'hard-light'  => esc_html__( 'Hard Light', 'taman-kit' ),
					'soft-light'  => esc_html__( 'Soft Light', 'taman-kit' ),
					'difference'  => esc_html__( 'Difference', 'taman-kit' ),
					'exclusion'   => esc_html__( 'Exclusion', 'taman-kit' ),
					'saturation'  => esc_html__( 'Saturation', 'taman-kit' ),
					'luminosity'  => esc_html__( 'Luminosity', 'taman-kit' ),
				),
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Overlay Opacity', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => array(
					'px' => array(
						'min'  => 0,
	...
	protected function register_style_feed_title_controls() {
		$this->start_controls_section(
			...
			array(
				'label'     => esc_html__( 'Feed Title', 'taman-kit' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'insta_profile_link' => 'yes',
				),
		...
		$this->add_control(
			'feed_title_position',
			array(
				'label'        => esc_html__( 'Position', 'taman-kit' ),
				'type'         => Controls_Manager::CHOOSE,
				'label_block'  => false,
				'default'      => 'middle',
				'options'      => array(
	...
	protected function register_style_arrows_controls() {
		$this->start_controls_section(
			...
			array(
				'label'     => esc_html__( 'Arrows', 'taman-kit' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'arrows'      => 'yes',
		...
		$this->add_control(
			'arrow',
			array(
				'label'       => esc_html__( 'Choose Arrow', 'taman-kit' ),
				'type'        => Controls_Manager::SELECT,
				'label_block' => false,
				'default'     => 'fa fa-angle-right',
				'options'     => array(
					'fa fa-angle-right'          => esc_html__( 'Angle', 'taman-kit' ),
					'fa fa-angle-double-right'   => esc_html__( 'Double Angle', 'taman-kit' ),
					'fa fa-chevron-right'        => esc_html__( 'Chevron', 'taman-kit' ),
					'fa fa-chevron-circle-right' => esc_html__( 'Chevron Circle', 'taman-kit' ),
					'fa fa-arrow-right'          => esc_html__( 'Arrow', 'taman-kit' ),
					'fa fa-long-arrow-right'     => esc_html__( 'Long Arrow', 'taman-kit' ),
					'fa fa-caret-right'          => esc_html__( 'Caret', 'taman-kit' ),
					'fa fa-caret-square-o-right' => esc_html__( 'Caret Square', 'taman-kit' ),
					'fa fa-arrow-circle-right'   => esc_html__( 'Arrow Circle', 'taman-kit' ),
					'fa fa-arrow-circle-o-right' => esc_html__( 'Arrow Circle O', 'taman-kit' ),
					'fa fa-toggle-right'         => esc_html__( 'Toggle', 'taman-kit' ),
					'fa fa-hand-o-right'         => esc_html__( 'Hand', 'taman-kit' ),
				),
			)
		);
		...
		$this->add_responsive_control(
			'arrows_size',
			array(
				'label'      => esc_html__( 'Arrows Size', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control(
			'left_arrow_position',
			array(
				'label'      => esc_html__( 'Align Left Arrow', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => array(
					'px' => array(
						'min'  => -100,
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Align Right Arrow', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => array(
					'px' => array(
						'min'  => -100,
	...
	protected function register_style_dots_controls() {
		$this->start_controls_section(
			'section_dots_style',
			array(
				'label'     => esc_html__( 'Pagination: Dots', 'taman-kit' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'feed_layout'     => 'carousel',
					'dots'            => 'yes',
		...
		$this->add_control(
			...
			array(
				...
				'type'         => Controls_Manager::SELECT,
				'options'      => array(
					'inside'  => esc_html__( 'Inside', 'taman-kit' ),
					'outside' => esc_html__( 'Outside', 'taman-kit' ),
				),
				'default'      => 'outside',
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Active Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
	...
	protected function register_style_fraction_controls() {
		$this->start_controls_section(
			...
			array(
				'label'     => esc_html__( 'Pagination: Fraction', 'taman-kit' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'feed_layout'     => 'carousel',
					'dots'            => 'yes',
	...
	public function render_editor_placeholder( $args = array() ) {
		...
		$defaults = array(
			...
			'body'  => __( 'This is a placeholder for this widget and is visible only in the editor.', 'taman-kit' ),
		);
	...
	public function get_insta_remote( $url ) {
		...
		if ( 200 !== $response_code ) {
			...
			: $this->render_editor_placeholder(
				array(
					'title' => esc_html__( 'No posts found', 'taman-kit' ),
				)
			);
		...
		if ( ! is_array( $result ) ) {
			return new \WP_Error( 'error', esc_html__( 'Data Error', 'taman-kit' ) );
		}
	...
	protected function render_api_images() {
		...
		if ( empty( $gallery ) || is_wp_error( $gallery ) ) {
			$message = is_wp_error( $gallery ) ? $gallery->get_error_message() : esc_html__( 'No Posts Found', 'taman-kit' );
							...
							if ( 'yes' === $the_seting_api ) {
								if ( '' === $settings['access_token'] ) {
									...
									echo $this->render_editor_placeholder( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										array(
											'title' => esc_html__( 'Instagram Feed not displayed!', 'taman-kit' ),
											'body'  => $placeholder,
										)
									);
								}
