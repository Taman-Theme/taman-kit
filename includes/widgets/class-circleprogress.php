...
class Circleprogress  extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style(
			'taman-kit-circle',
			TAMAN_KIT_URL . 'public/css/widgets/circle.css',
			array(),
	...
	public function get_title() {
		return esc_html__( 'Circleprogressbar', 'taman-kit' );
	}
	...
	protected function _register_controls() { // phpcs:ignore PSR2.Methods.MethodDeclaration.Underscore
		...
		*/
		...
		$this->start_controls_section(
			'section_values',
			array(
				'label' => esc_html__( 'Values', 'taman-kit' ),
			)
		);
		...
		$this->add_control(
			'values_type',
			array(
				'label'   => esc_html__( 'Progress Values Type', 'taman-kit' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'percent',
				'options' => array(
					'percent'  => esc_html__( 'Percent', 'taman-kit' ),
					'absolute' => esc_html__( 'Absolute', 'taman-kit' ),
				),
			)
		);
		...
		$this->add_control(
			'percent_value',
			array(
				'label'      => esc_html__( 'Current Percent', 'taman-kit' ),
		...
		$this->add_control(
			'absolute_value_curr',
			array(
				'label'     => esc_html__( 'Current Value', 'taman-kit' ),
		...
		$this->add_control(
			'absolute_value_max',
			array(
				'label'     => esc_html__( 'Max Value', 'taman-kit' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 100,
				'dynamic'   => version_compare( ELEMENTOR_VERSION, '2.7.0', '>=' ) ?
					array(
		...
		$this->add_control(
			'prefix',
			array(
				'label'       => esc_html__( 'Value Number Prefix', 'taman-kit' ),
		...
		$this->add_control(
			'suffix',
			array(
				'label'       => esc_html__( 'Value Number Suffix', 'taman-kit' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '%',
				'placeholder' => '%',
			)
		...
		$this->add_control(
			'thousand_separator',
			array(
				'label'     => esc_html__( 'Show Thousand Separator in Value', 'taman-kit' ),
		...
		$this->add_control(
			'title',
			array(
				'label'   => esc_html__( 'Counter Title', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
		...
		$this->add_control(
			'subtitle',
			array(
				'label'   => esc_html__( 'Counter Subtitle', 'taman-kit' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
				'dynamic' => array( 'active' => true ),
			)
		...
		$this->add_control(
			'percent_position',
			array(
				'label'   => esc_html__( 'Percent Position', 'taman-kit' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'in-circle',
				'options' => array(
					'in-circle'  => esc_html__( 'Inside of Circle', 'taman-kit' ),
					'out-circle' => esc_html__( 'Outside of Circle', 'taman-kit' ),
				),
			)
		);
		...
		$this->add_control(
			'labels_position',
			array(
				'label'   => esc_html__( 'Label Position', 'taman-kit' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'out-circle',
				'options' => array(
					'in-circle'  => esc_html__( 'Inside of Circle', 'taman-kit' ),
		...
		$this->add_responsive_control(
			'circle_size',
			array(
				'label'       => esc_html__( 'Circle Size', 'taman-kit' ),
				'type'        => Controls_Manager::SLIDER,
				'size_units'  => array( 'px' ),
				'default'     => array(
					'unit' => 'px',
		...
		$this->add_responsive_control(
			'value_stroke',
			array(
				'label'      => esc_html__( 'Value Stoke Width', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'default'    => array(
					'unit' => 'px',
		...
		$this->add_responsive_control(
			'bg_stroke',
			array(
				'label'      => esc_html__( 'Background Stoke Width', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'default'    => array(
					'unit' => 'px',
		...
		$this->add_control(
			'bg_stroke_type',
			array(
				'label'       => esc_html__( 'Background Stroke Type', 'taman-kit' ),
				'type'        => Controls_Manager::CHOOSE,
				'options'     => array(
					'color'    => array(
						'title' => esc_html__( 'Classic', 'taman-kit' ),
						'icon'  => 'fa fa-paint-brush',
					),
					'gradient' => array(
						'title' => esc_html__( 'Gradient', 'taman-kit' ),
						'icon'  => 'fa fa-barcode',
					),
				),
				'default'     => 'color',
		...
		$this->add_control(
			'val_bg_color',
			array(
				'label'     => esc_html__( 'Background Stroke Color', 'taman-kit' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Background Stroke Color A', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#54595f',
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Background Stroke Color B', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#858d97',
				'condition' => array(
					'bg_stroke_type' => array( 'gradient' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Background Stroke Gradient Angle', 'taman-kit' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 45,
				'min'       => 0,
				'max'       => 360,
		...
		$this->add_control(
			'val_stroke_type',
			array(
				'label'       => esc_html__( 'Value Stroke Type', 'taman-kit' ),
				'type'        => Controls_Manager::CHOOSE,
				'options'     => array(
					'color'    => array(
						'title' => esc_html__( 'Classic', 'taman-kit' ),
		...
		$this->add_control(
			'val_stroke_color',
			array(
				'label'     => esc_html__( 'Value Stroke Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#6ec1e4',
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Value Stroke Color A', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#6ec1e4',
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Value Stroke Color B', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#b6e0f1',
				'condition' => array(
					'val_stroke_type' => array( 'gradient' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Value Stroke Angle', 'taman-kit' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 45,
				'min'       => 0,
				'max'       => 360,
		...
		$this->add_control(
			'duration',
			array(
				'label'   => esc_html__( 'Animation Duration', 'taman-kit' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 1000,
				'min'     => 100,
				'step'    => 100,
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Progress Circle Style', 'taman-kit' ),
		...
		$this->add_control(
			'circle_fill_color',
			array(
				'label'     => esc_html__( 'Circle Fill Color', 'taman-kit' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => array(
		...
		$this->add_control(
			'line_endings',
			array(
				'label'     => esc_html__( 'Progress Line Endings', 'taman-kit' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'butt',
				'options'   => array(
					'butt'  => esc_html__( 'Flat', 'taman-kit' ),
					'round' => esc_html__( 'Rounded', 'taman-kit' ),
				),
				'selectors' => array(
		...
		$this->add_group_control(
			...
			array(
				...
				'label'    => esc_html__( 'Circle Box Shadow', 'taman-kit' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Content Style', 'taman-kit' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'number_style',
			array(
				'label'     => esc_html__( 'Number Styles', 'taman-kit' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Prefix Font Size', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
					'em',
		...
		$this->add_responsive_control(
			'number_prefix_gap',
			array(
				'label'      => esc_html__( 'Prefix Gap (px)', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
				),
		...
		$this->add_responsive_control(
			...
			array(
				'label'       => esc_html__( 'Prefix Alignment', 'taman-kit' ),
				'type'        => Controls_Manager::CHOOSE,
				'label_block' => false,
				'default'     => 'center',
				'options'     => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Suffix Font Size', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
					'em',
		...
		$this->add_responsive_control(
			'number_suffix_gap',
			array(
				'label'      => esc_html__( 'Suffix Gap (px)', 'taman-kit' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
				),
		...
		$this->add_responsive_control(
			...
			array(
				'label'       => esc_html__( 'Suffix Alignment', 'taman-kit' ),
				'type'        => Controls_Manager::CHOOSE,
				'label_block' => false,
				'default'     => 'center',
				'options'     => array(
		...
		$this->add_control(
			'title_style',
			array(
				'label'     => esc_html__( 'Title Styles', 'taman-kit' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			),
			25
		...
		$this->add_control(
			'subtitle_style',
			array(
				'label'     => esc_html__( 'Subtitle Styles', 'taman-kit' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			),
		);
				...
				<div <?php echo $this->get_render_attribute_string( 'circle-wrap' );  // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
					<div <?php echo $this->get_render_attribute_string( 'circle-bar' );  // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>>
						<?php
							...
							include Templates::get_templatet( 'progress', 'circle' );
